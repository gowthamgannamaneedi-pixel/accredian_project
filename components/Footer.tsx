          ...
          <div className="lg:col-span-2 space-y-4">
            <Link href="#" className="flex items-center gap-3">
              <div className="flex flex-col leading-none">
                <span className="text-xl font-extrabold text-[#168CFF]" style={{ letterSpacing: '-0.02em' }}>accredian</span>
                <span className="text-[9.5px] text-slate-400 font-medium" style={{ letterSpacing: '0.02em' }}>credentials that matter</span>
              </div>
              <span className="px-2 py-0.5 text-[9px] font-extrabold uppercase tracking-widest rounded bg-slate-800 text-[#0284C7] border border-slate-700">
                ENTERPRISE
              </span>
            </Link>
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a
                ...
                className="w-9 h-9 rounded-lg bg-slate-800 hover:bg-[#0A66C2] text-slate-300 hover:text-white border border-slate-700 flex items-center justify-center transition-colors"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg bg-slate-800 hover:bg-black text-slate-300 hover:text-white border border-slate-700 flex items-center justify-center transition-colors"
                aria-label="Accredian on Twitter/X"
              >
                <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg bg-slate-800 hover:bg-red-600 text-slate-300 hover:text-white border border-slate-700 flex items-center justify-center transition-colors"
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/accredian"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg bg-slate-800 hover:bg-gradient-to-br hover:from-purple-600 hover:via-pink-500 hover:to-orange-400 text-slate-300 hover:text-white border border-slate-700 flex items-center justify-center transition-all"
